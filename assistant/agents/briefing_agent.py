...
class BriefingAgent(BaseAgent):
    ...
    def _generate_html(self, emails: list, calendar: list, tickets: list, ai_summary: str) -> Path:
        ...
        # Jira rows — show In Progress / Ready tickets as "open"
        ticket_rows_open = ""
        open_count = 0
        critical_count = 0
        open_statuses = ("In Progress", "Ready", "In Review")
        for t in tickets:
            status = t["status"]
            ...
            status_class = {
                ...
                "Ready": "status-progress", "In Review": "status-progress",
...
<div class="container">
  ...
  <div class="stats">
    ...
    <a href="#open-tickets" class="stat-card critical">
